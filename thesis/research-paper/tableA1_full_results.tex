\begin{table*}[!htb]
\caption{Complete algorithm comparison across all ensemble strategies. Accuracy on held-out test sets. Missing H-U (Hydra-Univariate) entries correspond to multivariate datasets; missing H-M (Hydra-Multivariate) entries correspond to univariate datasets. FC-R on Traffic timed out due to dataset size and algorithm complexity.}\label{tab:full_results}
\centering
\footnotesize
